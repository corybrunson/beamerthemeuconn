...
\useinnertheme{uconn}
\useoutertheme[bgleaf,logo=uconnhealth]{uconn}
...
The woodmark used in the footer is determined by the \verb|logo| option:

\begin{verbatim}
\useoutertheme[logo=uconnhealth]{uconn}
\end{verbatim}

It currently accepts the following options:
\begin{itemize}
\item \verb|uconn|
\item \verb|uconnhealth|
\end{itemize}

Any other option will produce no footer logo.
