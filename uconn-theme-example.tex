...
\usetheme[bgleaf,logo=uconnhealth]{uconn}
...
They are activated by the \verb|bgleaf| and \verb|logo| options:

\begin{verbatim}
\usetheme[bgleaf,logo=uconnhealth]{uconn}
\end{verbatim}

The \verb|logo| option currently accepts the following options:
\begin{itemize}
\item \verb|uconn|
